...
const projects = [
  ...
  description:
    "A full-stack URL shortener with real-time click tracking, responsive design, and role-based authentication.",
...
},
{
  ...
  description:
    "Full-stack scheduling app with Google Calendar sync, real-time availability checks, and role-based access.",
